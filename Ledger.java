...
//                }
    ...
    public void payLoan(double amount) {
        ...
        // todo This can make the agent go into negative cash. Temporarily, we check here.
        if (defaultCashAccount.getTotal() < amount) {
            System.out.println(bank.getName()+" must raise liquidity immediately.");
            bank.raiseLiquidity(amount * (1 - defaultCashAccount.getTotal()/getAssetValue()));
        }
